    ...
    def callback_scan(data) -> None:
        ...
        if robotcl.mode == 0:
            ...
            # move
                ...
                ArrForMove = robotcl.abcd.setSpeed(x, y)
            ...
            # print(robotcl.mode)
            JoyArr = robotcl.abcd.setSpeed(robotcl.JoySpeed[0], robotcl.JoySpeed[1], turnOsSys=45, ModeOfAngles = 1, FuncOfAngel = [0, -robotcl.JoyAngle])
